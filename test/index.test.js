...
describe('Chatting', () => {
  ...
  it('Broadcasts new chat message to other users', (done) => {
    const testMessage = {
      username: chatUser1.username,
      message: 'test message',
      avatar: 'user avatar',
      messageClass: 'from-me whiteText',
    };

    // const serverBroadcast = testMessage;
    // serverBroadcast.messageClass = 'from-them blackText';
    // console.log(serverBroadcast);
